...
/*     */ import net.mcreator.dreamboss.procedures.DreamOnInitialEntitySpawnProcedure;
...
/*     */ 
/*     */ @Tag
/*     */ public class DreamEntityEntity extends DreambossModElements.ModElement {
/*  58 */   public static EntityType entity = null;
/*     */   public DreamEntityEntity(DreambossModElements instance) {
/*  60 */     super(instance, 15);
/*  61 */     FMLJavaModLoadingContext.get().getModEventBus().register(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */     entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).func_220320_c().func_220321_a(0.6F, 1.8F).func_206830_a("dream_entity").setRegistryName("dream_entity");
/*  69 */     this.elements.entities.add(() -> entity);
/*     */   }
/*     */   
/*     */   @SubscribeEvent
/*     */   @OnlyIn(Dist.CLIENT)
/*     */   public void registerModels(ModelRegistryEvent event) {
/*  75 */     RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
/*     */           BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0.0F), 0.5F)
/*     */             {
/*     */               public ResourceLocation func_110775_a(Entity entity) {
/*  79 */                 return new ResourceLocation("dreamboss:textures/dream1.png");
/*     */               }
/*     */             };
...
/*  88 */     public CustomEntity(FMLPlayMessages.SpawnEntity packet, World world) { this(DreamEntityEntity.entity, world); }
...
/*  92 */     public CreatureAttribute func_70668_bt() { return CreatureAttribute.field_223222_a_; } public CustomEntity(EntityType<CustomEntity> type, World world) { super(type, world);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 239 */     public SoundEvent func_184601_bQ(DamageSource ds) { return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.generic.hurt")); } public void func_184178_b(ServerPlayerEntity player) { super.func_184178_b(player);
/* 240 */       this.bossInfo.func_186760_a(player); } public SoundEvent func_184615_bR() { return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.generic.death")); }
...
/* 245 */     public void func_184203_c(ServerPlayerEntity player) { super.func_184203_c(player);
/* 246 */       this.bossInfo.func_186761_b(player); } public ILivingEntityData func_213386_a(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata, CompoundNBT tag) { ILivingEntityData retval = super.func_213386_a(world, difficulty, reason, livingdata, tag); double x = func_226277_ct_(); double y = func_226278_cu_(); double z = func_226281_cx_(); CustomEntity customEntity = this; Map<String, Object> $_dependencies = new HashMap<>(); $_dependencies.put("entity", customEntity); $_dependencies.put("world", world); DreamOnInitialEntitySpawnProcedure.executeProcedure($_dependencies); return retval; }
/*     */     public void func_70030_z() { super.func_70030_z(); double x = func_226277_ct_(); double y = func_226278_cu_(); double z = func_226281_cx_(); CustomEntity customEntity = this; Map<String, Object> $_dependencies = new HashMap<>(); $_dependencies.put("x", Double.valueOf(x)); $_dependencies.put("y", Double.valueOf(y));
/*     */       $_dependencies.put("z", Double.valueOf(z));
/*     */       $_dependencies.put("world", this.field_70170_p);
/*     */       DreamEntityOnEntityTickUpdateProcedure.executeProcedure($_dependencies); }
/* 251 */     public void func_70619_bc() { super.func_70619_bc();
/* 252 */       this.bossInfo.func_186735_a(func_110143_aJ() / func_110138_aP()); }
/*     */ 
/*     */     
